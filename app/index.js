  ...
              </div>
              <div style={styles.modalActions}>
                <button style={styles.btnPrimary} onClick={handleAdicionarVacina}>Adicionar Vacina</button>
                <button style={{...styles.btnSecondary}} onClick={() => setShowModalVacina(false)}>Cancelar</button> {/* Estilo secundário */}
              </div>
            </div>
          </div>
        )}
